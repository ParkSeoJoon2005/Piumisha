...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("I was created by Lyciabot Team.", "I was created by ⚡𝐋𝐈𝐊𝐔 𝐂𝐒⚡ Team.")
        ...
        result = result.replace("Eliza", "@Lyciachatbot")
        result = result.replace("Hi~", "Hello Friend I Am @Lyciachatbot")
        result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By ⚡𝐋𝐈𝐊𝐔 𝐂𝐒⚡")
        result = result.replace("Have the control right.", "My Father Is ⚡𝐋𝐈𝐊𝐔 𝐂𝐒⚡")
...
async def redaura(client, message):
    ...
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By ⚡𝐋𝐈𝐊𝐔 𝐂𝐒⚡")
    result = result.replace("Have the control right.", "My Father Is ⚡𝐋𝐈𝐊𝐔 𝐂𝐒⚡")
    result = result.replace("I was created by Lyciabot Team.", "I was created by ⚡𝐋𝐈𝐊𝐔 𝐂𝐒⚡ Team.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
